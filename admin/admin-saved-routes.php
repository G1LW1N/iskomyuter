...
<head>
    ...
    <title>Admin - Saved Routes</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="admin-saved-routes.php" class="active"><i class='bx bx-map'></i><span>Saved Routes</span></a></li>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            $transportClass = (strtolower($row["transportmode"]) == 'jeep') ? 'transport-jeep' : 'transport-default';
                            echo '<tr>
                                    <td>' . htmlspecialchars($row["id"]) . '</td>
                                    <td>' . htmlspecialchars($row["userid"]) . '</td>
                                    <td>' . htmlspecialchars($row["start"]) . '</td>
                                    <td>' . htmlspecialchars($row["destination"]) . '</td>
                                    <td><span class="transport-badge ' . $transportClass . '">' . htmlspecialchars($row["transportmode"]) . '</span></td>
                                    <td>' . htmlspecialchars($row["distance"]) . ' km</td>
                                    <td>₱ ' . htmlspecialchars($row["fare"]) . '</td>
                                    <td>' . htmlspecialchars($row["duration"]) . '</td>
                                    <td>' . htmlspecialchars($row["created_at"]) . '</td>
                                    <td>
                                        <button class="delete-btn" onclick="if(confirm(\'Are you sure you want to delete this route?\')) location.href=\'admin-deleteroutes.php?routeid=' . $row["id"] . '\'" title="Delete">
