                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>
                                    ...
                                    <td>
                                        <a class="delete" title="Delete" data-toggle="tooltip" onclick=location.href="../controllers/deletefeedback.php?id=' . $row["id"] . '" style="cursor: pointer;"><i class="material-icons">delete</i></a>
                                    </td>
                                </tr>';
                        }
                        $stmt->close();
